            ...
            public void onSuccess(Object responseObj) {
                ...
                if (dingDan.getCode()== BianLiDianStatus.STATUS_CODE_SUCCESS){
                    ...
                    for (int i=mList.size()-1;i>=0;i--){
                        ...
                        if (mList.get(i).getOrderInfo().getOrderNo().equals("10020170727483")){
                            Log.i("yyy",mList.get(i).getOrderInfo().getStatus()+"---"
                            +mList.get(i).getOrderInfo().getSubStatus());
                        }
                            ...
                            switch (mList.get(i).getOrderInfo().getStatus()){
                                ...
                                case 93:
                                    ...
                                    break;
//                                case 100:
//                                    if (mList.get(i).getOrderInfo().getSubStatus() == 130) {
//                                        mList.remove(i);
//                                        break;
//                                    }
//                                    if (mList.get(i).getOrderInfo().getSubStatus() == 120) {
//                                        mList.remove(i);
//                                        break;
//                                    }
//                                    if (mList.get(i).getOrderInfo().getSubStatus() == 230) {
//                                        mList.remove(i);
//                                        break;
//                                    }
//                                    if (mList.get(i).getOrderInfo().getSubStatus() == 220) {
//                                        mList.remove(i);
//                                        break;
//                                    }
                            }
