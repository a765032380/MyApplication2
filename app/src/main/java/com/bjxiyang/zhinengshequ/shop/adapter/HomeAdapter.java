                            ...
                            viewHolder.button_one.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    RequestCenter.order_refuse(url_judan, new DisposeDataListener() {
                                        @Override
                                        public void onSuccess(Object responseObj) {
                                            finalViewHolder2.button_one.setVisibility(View.GONE);
                                            finalViewHolder2.button_two.setText("退款中");
...
//                                    });
                    ...
                    case 93:
                        ...
                        break;
                    case 100:
                        if (mList.get(position).getOrderInfo().getSubStatus() == 130) {
                            viewHolder.button_one.setVisibility(View.GONE);
                            viewHolder.button_two.setVisibility(View.GONE);
                            viewHolder.dingdanzhuangtai.setText("退货拒绝");
                        }

                        if (mList.get(position).getOrderInfo().getSubStatus() == 230) {
                            viewHolder.button_one.setVisibility(View.GONE);
                            viewHolder.button_two.setVisibility(View.GONE);
