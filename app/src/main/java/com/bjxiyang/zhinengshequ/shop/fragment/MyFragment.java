...
//    private Button jianchagengxin;
    ...
    private TextView tv_shangjianame;
    ...
    private void initUi() {
        tv_shangjianame= (TextView) view.findViewById(R.id.tv_shangjianame);
...
//        jianchagengxin.setOnClickListener(this);
        ...
        Log.i("yyy",SPManager.getInstance().getString("logo",null));
        if (SPManager.getInstance().getString("logo",null)!=null){
            ImageLoaderManager.getInstance(getContext())
                    .displayImage(dianpu_touxiang,SPManager.getInstance().getString("logo",null));
        }
        if (SPManager.getInstance().getString("ShopName",null)!=null){
            tv_shangjianame.setText(SPManager.getInstance().getString("ShopName","店名"));
        }
